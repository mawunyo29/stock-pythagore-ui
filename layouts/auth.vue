...
const cruds = ref([
  { name: 'Products', link: '/admin/crud/products' },
  { name: 'Pages', link: '/admin/crud/pages' },
  { name: 'Users', link: '/users' }
])
const dropDownPages = ref([
  { name: 'Pricing', link: '#' },
  { name: 'Maintenance', link: '#' },
  { name: '404 not found', link: '#' },
  { name: '500 server error', link: '#' }
])
const dropdownAuths = ref([
  { name: 'Sign in', link: '#' },
  { name: 'Sign up', link: '#' },
  { name: 'Forgot password', link: '#' },
  { name: 'Reset password', link: '#' },
  { name: 'Profile lock', link: '#' }
])
...
//accordion for the dropdown animation
const beforeEnter = (el) => {
  el.style.height = '0'
  el.style.overflow = 'hidden'
  el.style.transition = 'height 1s ease-in-out, transform 0.5s ease-in-out'
...
const enter = (el) => {
  ...
  el.style.overflow = 'hidden'
  el.style.transition = 'max-height 0.3s ease-out, padding 0.3s ease'
  el.style.transform = 'translateY(0)'
}
...
const toggleSideMenu = (e) => {
  ...
  // if (e === 'layoutDrop') {
  //   //check if  layoutDrop have class hidden

  //   layoutDrop.value = document.getElementById('dropdown-layouts')

  //   if (layoutDrop.value.classList.contains('hidden')) {
  //     layoutDrop.value.classList.remove('hidden')
  //     layoutDrop.value.classList.add('block')
  //   } else {
  //     layoutDrop.value.classList.remove('block')
  //     layoutDrop.value.classList.add('hidden')
  //   }

  //   openSideMenu.value = !openSideMenu.value
  // }
  // if (e === 'dropdownCrud') {
  //   dropdownCrud.value = document.getElementById('dropdown-crud')

  //   if (dropdownCrud.value.classList.contains('hidden')) {
  //     dropdownCrud.value.classList.remove('hidden')
  //     dropdownCrud.value.classList.add('block')
  //   } else {
  //     dropdownCrud.value.classList.remove('block')
  //     dropdownCrud.value.classList.add('hidden')
  //   }
  //   isDropdownCrud.value = !isDropdownCrud.value
  // }
}
watchEffect(() => {
...
onMounted(() => {
  ...
  sideNav.value.forEach((item) => {
    ...
    item.addEventListener('click', (e) => {
      e.preventDefault()
      openContent.value = item.parentElement.querySelector(".open-container");

      let accordionMaxHeight = openContent.value.style.maxHeight;
      const sidebarToggleItem = item.querySelectorAll("[sidebar-toggle-item]")[1];
      //get svg  with sidebar-toggle-item


      // Condition handling
      if (accordionMaxHeight == "0px" || accordionMaxHeight.length == 0) {
        openContent.value.style.maxHeight = `${openContent.value.scrollHeight + 32}px`;
        // item.querySelector(".fas").classList.remove("fa-plus");
        // item.querySelector(".fas").classList.add("fa-minus");

        sidebarToggleItem.classList.add('rotate-180', 'transform', 'duration-500', 'ease-in-out');
        item.classList.add('active');

        console.log(item.classList);
        //rotate the icon or svg
        // item.querySelector(".fas").classList.add("fa-minus");
        // item.querySelector(".fas").classList.remove("fa-plus");


      } else {
        openContent.value.style.maxHeight = `0px`;
        sidebarToggleItem.classList.remove("bg-gray-100");
        sidebarToggleItem.classList.remove("dark:bg-gray-700");
        sidebarToggleItem.classList.remove('rotate-180', 'transform', 'duration-500', 'ease-in-out');
        item.classList.remove('active');

        // item.querySelector(".fas").classList.add("fa-plus");
        // item.querySelector(".fas").classList.remove("fa-minus");
    ...
    <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
      <aside id="sidebar"
        ...
        <div
          ...
          <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto scroll-m-1">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
              <ul class="pb-2 space-y-2 " ref="sideNav">
                <li>
                ...
                <li>
                  <NuxtLink to="/products"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                      class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                      viewBox="0 0 16 16" id="meteor-icon-kit__regular-products-s" fill="none">
                ...
                <li>
                  <NuxtLink to="/products"
                    class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                      fill="none">
                      <rect x="6" y="28" width="36" height="14" rx="4" stroke="#000000" stroke-width="4" />
                      <path d="M20 7H10C7.79086 7 6 8.79086 6 11V17C6 19.2091 7.79086 21 10 21H20" stroke="#000000"
                ...
                <li>
                  <NuxtLink to="/stock"
                    ...
                    <span class="ml-3" sidebar-toggle-item>Stock</span>
                  </NuxtLink>

                </li>
                <!-- <li>
                  <button type="button" @click="toggleSideMenu('layoutDrop')"
                    class="open flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                  ...
                  <TransitionGroup tag="ul" @before-enter="beforeEnter" @enter="enter" @before-leave="beforeLeave"
                ...
                <!-- <li>
                  <button type="button" @click="toggleSideMenu('dropdownCrud')"
                    class="open flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                  ...
                  <TransitionGroup tag="ul" id="dropdown-crud" @before-enter="beforeEnter" @enter="enter"
                ...
                <li>
                  ...
                  <TransitionGroup tag="ul" @before-enter="beforeEnter" @enter="enter" @before-leave="beforeLeave"
                    @leave="leave" class="py-2 space-y-2 overflow-hidden transition open-container max-h-0"
                    id="dropdown-pages">
                ...
                <li>
                  ...
                  <TransitionGroup tag="ul" @before-enter="beforeEnter" @enter="enter" @before-leave="beforeLeave"
                    @leave="leave" class="py-2 space-y-2 group overflow-hidden transition open-container max-h-0"
...
[sidebar-bottom-menu] button {
  transition: all 0.2s;
}

[sidebar-bottom-menu] button:hover {
  color: #4f46e5;
}

[sidebar-bottom-menu] button svg {
  transition: all 0.2s;
}

[sidebar-bottom-menu] button:hover svg {
  fill: #4f46e5;
  transform: scale(1.1);
}

[sidebar-bottom-menu] [data-tooltip-target] {
  transition: all 0.2s;
}

[sidebar-bottom-menu] [data-tooltip-target]:hover {
  color: #4f46e5;
}

[sidebar-bottom-menu] [data-dropdown-toggle] {
  transition: all 0.2s;
}

[sidebar-bottom-menu] [data-dropdown-toggle]:hover {
  color: #4f46e5;
}

[sidebar-bottom-menu] [data-dropdown-toggle]:hover svg {
  fill: #4f46e5;
}
