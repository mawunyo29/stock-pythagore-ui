...
onMounted(() => {
  ...
  sideNav.value.forEach((item) => {
    item.addEventListener("click", (e) => {
      ...
      const sidebarToggleItem = item.querySelectorAll(
        "[sidebar-toggle-item]"
      )[1];
      ...
      if (accordionMaxHeight == "0px" || accordionMaxHeight.length == 0) {
        openContent.value.style.maxHeight = `${
          openContent.value.scrollHeight + 32
        }px`;
        // item.querySelector(".fas").classList.remove("fa-plus");
        // item.querySelector(".fas").classList.add("fa-minus");

        sidebarToggleItem.classList.add(
          "rotate-180",
          "transform",
          "duration-500",
          "ease-in-out"
        ...
        sidebarToggleItem.classList.remove(
          "rotate-180",
          "transform",
          "duration-500",
          "ease-in-out"
  ...
  <div class="bg-gray-50">
    ...
    <div class="flex overflow-hidden dark:bg-gray-900">
      ...
      >
        ...
        >
          <div
            class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto scroll-m-1"
          >
            <div
            ...
            >
              <ul class="pb-2 space-y-2" ref="sideNav">
                ...
                <li>
                  ...
                  >
                    <li
                      v-for="(auth, index) in dropdownAuths"
                      :data-index="index"
                      :key="auth.name"
                    >
                      <a
                ...
                <li>
                  ...
                  <TransitionGroup
                    ...
                    @before-leave="beforeLeave"
                    @leave="leave"
                    class="py-2 space-y-2 group overflow-hidden transition open-container max-h-0"
      ...
      <div
        id="main-content"
        class="relative w-full h-full overflow-y-auto bg-gray-50 lg:ml-64 dark:bg-gray-900 overflow-auto top-7"
      >
        <main class="">
          <div>
            <slot />
