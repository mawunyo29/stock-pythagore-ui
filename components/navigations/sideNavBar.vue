...
<template>
  <aside
    id="sidebar"
    class="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 hidden sm:w-[calc(16rem-4rem)] lg:w-64 h-full pt-14 font-normal duration-75 lg:flex transition-width"
    aria-label="Sidebar"
  >
    <div
          ...
          <ul class="pb-2 space-y-2" ref="sideNav">
            ...
            <li>
              ...
              >
                ...
                <span class="ml-3" sidebar-toggle-item>Fournisseur</span>
              </NuxtLink>
            </li>
            <li>
              <NuxtLink
