<template>
  <nav class="fixed z-50 w-full bg-[#020420]/30 border-b border-gray-200 sm:py-2 dark:bg-gray-800 dark:border-gray-700 bg-gradient-to-bl from-[#020420]/60 ">
  <div class="container py-2 mx-auto">
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start">
        <a href="#" class="flex mr-4">
          <!-- <img src="/images/logo.svg" class="h-8 mr-3" alt="Flowbite Logo" /> -->
          <span class="self-center text-2xl font-semibold whitespace-nowrap text-white te">PYTHAGORE</span>
        </a>
